...
const EmployeeListHeader = ({onClickDirectOrAllFilter, count, loadDirectEmployees}) => {
                    ...
                    <div className="d-sm-flex  d-block align-items-center">
                        ...
                        <div className="media-body">
                            ...
                            <Button
                                ...
                                variant={loadDirectEmployees ? "danger" : "outline-primary"}
                                onClick={onClickDirectOrAllFilter}
                            >
                                {loadDirectEmployees ? "Show all" : "Direct Report"}
                            </Button>
                            </h3>
                        </div>
                        </div>
