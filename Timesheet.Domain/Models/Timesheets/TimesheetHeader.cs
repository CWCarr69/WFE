...
namespace Timesheet.Domain.Models.Timesheets
{
  public class TimesheetHeader : AggregateRoot
  {
    ...
    public void DeleteTimesheetEntry(TimesheetEntry timesheetEntry, bool force = false)
    {
      ...
      var employeeId = timesheetEntry.EmployeeId;
      var hours = timesheetEntry.Quantity;
      var typeId = timesheetEntry.PayrollCodeId;

      var deletedEntry = new TimeoffDeletedEntry(
           employeeId,
           typeId,
           hours);

      RaiseDomainEvent(new TimeoffDeleted(deletedEntry, true));
    }
